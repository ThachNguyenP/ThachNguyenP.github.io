...
- **Writer** có thể **create**, **edit**, **update** và **delete** các bài **post** của họ. Ngoài ra thì còn có thể xem các bài **post** của các **writer** khác.
...
Đội phát triển của **Pundit** xem chừng cũng khá có tâm nghĩ cho người dùng nên mới đẻ ra cái tính năng này, đó là khả năng phân quyền tới params trong controller.
