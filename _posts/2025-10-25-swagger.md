...
Rswag::Api.configure do |c|
  ...
  # NOTE: If you're using the provided generator, the file will be placed in the API folder

  # For Grape API, we'll serve the swagger JSON directly from the Grape endpoint
  # The middleware will convert it from Swagger 2.0 to OpenAPI 3.0
...
Rswag::Ui.configure do |c|
  ...
  # NOTE: If you're using rspec-based specs, the path will be prefixed with an "api" by default
  c.openapi_endpoint '/api/v1/swagger_doc.json', 'Chemistry DSG API v1'
end
```
